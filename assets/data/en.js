window.PORTFOLIO_LOCALE = {
  data: {
      ...
      heroHeadlines: [
        ...
        "I build small systems with fewer excuses.",
        "Software with boundaries, records, and a working pulse.",
        "I turn vague ideas into things with endpoints.",
        "Backend first, personality not entirely removed.",
        "Systems that prefer being understood over being admired.",
        "I like tools that remember why they exist.",
        "Small software, explicit rules, fewer undefined corners.",
        "I build the plumbing and occasionally let it look alive.",
        "Structured systems for ideas that refuse to sit still.",
        "Interfaces can be expressive. Data should stay calm.",
        "I make systems less mysterious, which is plain but useful.",
        "Backend systems, visible tradeoffs, limited theatrics.",
        "I build tools that survive being opened again.",
        "Less hand-waving, more state management.",
        "I design systems that do not require ceremonial guessing.",
        "Personal software with actual load-bearing structure.",
        "I write code that tries not to become archaeology.",
        "Small products, clear rules, deployable consequences.",
        "I build systems that can explain themselves under pressure.",
        "Backend work with receipts.",
        "A homepage that admits software has edges.",
        "I prefer clear failures over decorative success.",
        "Tools for workflows that got tired of being notes.",
        "I build systems before the adjectives arrive.",
        "Software that keeps its promises in version control.",
        "I like APIs with manners and data with a spine.",
        "Useful structure, slightly playful interface.",
        "I build things that can be debugged without folklore.",
        "Systems thinking, small tools, no smoke machine.",
        "A builder of tools, records, and slightly stubborn boundaries.",
        "I make vague workflows file a proper address.",
        "Backend architecture for problems that outgrew a spreadsheet.",
        "I build quiet systems with visible seams.",
        "Less branding, more behavior.",
        "I build software that can be questioned politely.",
        "Readable systems for large amounts of context.",
        "I turn product fog into backend weather reports.",
        "Small systems, sharp boundaries, minimal hand-waving.",
        "I build tools that remember the boring important parts.",
        "Backend systems with fewer hidden rituals.",
        "I like software that leaves a map behind.",
        "Personal infrastructure, not productivity theater.",
        "I build clear systems for messy real-world inputs.",
        "Software that knows where the tricky parts are.",
        "I care where the data goes after the button is clicked.",
        "Systems with constraints, not vibes in a trench coat.",
        "I build the part that still matters after the demo.",
        "A compact page for systems that dislike hidden logic.",
        "I write software that tries to make future me less confused.",
        "Clear models, real boundaries, controlled chaos."
      ],
      ...
      heroSubheads: [
        ...
        "Computer science student. Mostly backend, personal data systems, and interfaces that avoid the template aisle.",
        "Backend-leaning, fond of clear system boundaries, and reluctant to make a homepage read like a flyer.",
        "I write Go, SQL, Docker, and small systems. Interfaces may have personality; systems need boundaries.",
        "Mostly backend, personal software, and controlled AI workflows.",
        "I build things that deploy, explain themselves, and remain maintainable; less good at writing empty slogans.",
        "Backend is the main thread, personal software is the interest, and interface experiments keep the homepage from becoming a manual.",
        "I like small, clear systems and homepages that look like a person actually wrote them.",
        "I write APIs, data models, and deployment paths, and care whether a personal homepage can avoid the template smell.",
        "Backend engineering, data modeling, system boundaries, and a little expression that refuses to be flattened into resume format.",
        "Computer science background, backend-leaning projects, and a habit of turning messy workflows into clear boundaries.",
        "The projects show capability; the homepage shows this was not copy-pasted.",
        "I care about how systems survive long-term, and whether a personal homepage can show some judgment.",
        "A backend person who does not want a personal homepage to look like an internal corporate page.",
        "Mostly services, data objects, and small tools; the page simply refuses to be overly polite.",
        "I turn messy workflows into system boundaries, then build them into things that run.",
        "Backend, personal infrastructure, AI guardrails, and a little expression that refuses to pose as a template.",
        "Builder of small systems. Focused on data, permissions, deployment, and whether a project still makes sense six months later.",
        "I build backend systems and personal tools, preferring clear boundaries, inspectable failures, and non-mystical deployment.",
        "The stack is practical. The presentation refuses to be taken over by templates.",
        "I care about boundaries when writing code, and a little contrast when writing a homepage.",
        "The backend systems are treated seriously; the homepage handles not looking too much like a spreadsheet.",
        "Main interests: APIs, data models, runtime boundaries, and personal software.",
        "I like inspectable systems and personal introductions that avoid stock phrasing.",
        "Restrained when building systems, slightly less restrained when building the homepage.",
        "I build shippable small tools and an intro page that does not want to dress like a career template.",
        "Backend-oriented, with a habit of turning foggy requirements into implementable systems.",
        "I care about object identity, permission boundaries, search paths, and whether software can keep growing.",
        "I write backend systems and personal tools; neither should survive on nice wording alone.",
        "I mostly build small, hard-edged systems: clear scope, explicit boundaries, and deployable paths.",
        "I treat records, permissions, search, and AI requests as parts of the same system problem.",
        "Backend engineering is not just putting data in a database; it is deciding who can touch what, and when.",
        "I like products with controlled scope and engineering choices that can be explained clearly.",
        "Personal software, backend systems, AI workflows. The direction is not flashy; the entry point may have some attitude.",
        "The things I build often start as messy workflows and end as systems with clearer boundaries.",
        "I write services, data models, deployment paths, and a self-introduction that does not read like a template.",
        "Backend-leaning, personal-infrastructure-leaning, and biased toward making system failure modes visible.",
        "When building software, I look at boundaries first, features second, and only then let the interface have an expression.",
        "I mostly build things that run, can be inspected, and can be maintained; not trying to package myself as a universal operator.",
        "Backend systems, classroom tools, personal data. Common rule: scope cannot be vague, and boundaries cannot rely on guesswork.",
        "I like the hard problems inside small systems: permissions, identity, deployment, auditing, and future maintenance.",
        "This shows projects, not a perfect persona; running systems matter more than polished packaging.",
        "I write backend, build tools, and break down workflows; the page should not sound like automatically generated politeness.",
        "I treat personal data, system boundaries, and AI usage patterns as serious engineering problems.",
        "The projects are practical, the wording is direct, and the interface refuses to be a template’s relative.",
        "Computer science student, currently more interested in how backend systems are constrained, deployed, and maintained.",
        "I build small backend systems and personal tools, aiming to keep complexity from hiding behind a pretty shell.",
        "The code makes things work; the copy makes sure the person is not erased.",
        "I like explicit interfaces, explainable state, and engineering choices that do not pretend to be mysterious.",
        "The direction is plain: backend, data, tools, deployment, and a little personal judgment.",
        "I write systems that are not too large, but every boundary should have a reason.",
        "The backend projects are evidence; the interface tone is a filter.",
        "I build backend-heavy tools where records, permissions, and workflows are treated as real system problems instead of decorative implementation details.",
        "Most of my work starts with a concrete question: what exactly is this system allowed to know, store, change, and expose?",
        "I like software with clear object identity, boring deployment paths, and enough structure that future maintenance still feels manageable.",
        "The projects here lean toward backend architecture, personal data systems, AI-assisted workflows, and interfaces that show the structure instead of hiding it.",
        "I care less about pretending software is effortless and more about making the effort visible, inspectable, and worth maintaining.",
        "My preferred stack is practical: Go, SQL, Docker, CI/CD, APIs, and enough product judgment to avoid building something pretty but unclear.",
        "I build small systems with explicit rules because vague software eventually becomes everyone’s maintenance problem.",
        "The work below is not pretending to be a giant platform. It is a set of focused systems with boundaries, tradeoffs, and working parts.",
        "I am interested in software that keeps context alive: what happened, who changed it, why it exists, and how it can be safely extended.",
        "The goal is simple enough to stay useful: define the rules, build the system, ship it, and leave behind something explainable.",
        "I use AI where it helps implementation move faster, not where it replaces requirements, boundaries, review, or basic responsibility.",
        "My projects usually live near the practical center of software: data models, authorization, services, deployment, and cleanup after the clever idea.",
        "This homepage is intentionally compact because pretending every small project is a world-changing platform makes the signal weaker.",
        "I like building tools where the interface is allowed to have character, but the backend still has to behave predictably.",
        "The common thread is control: records, permissions, runtime boundaries, deployment paths, and the refusal to let complexity vanish behind a button.",
        "I build software for workflows that are too structured to remain notes and too specific to deserve a generic app-shaped cage.",
        "My work is backend-leaning, but I still care about the product surface because users should not need a debugger to understand intent.",
        "I prefer systems where failures are visible, permissions are explicit, and future changes do not require a small archaeological expedition.",
        "The page is not trying to sound universally employable. It is trying to show a person who can scope, build, deploy, and explain systems.",
        "I care about maintainability not as a slogan, but as the difference between extending a project and carefully untangling it later.",
        "The systems I build are usually small enough to understand and strict enough to avoid becoming a pile of polite accidents.",
        "I like turning messy product ideas into constrained backend systems, then giving them interfaces that reveal rather than launder the complexity.",
        "The stack is normal on purpose. The interesting part is how the rules, records, and boundaries fit together without becoming presentation fog.",
        "I build tools that keep enough structure around decisions, because future-you deserves more than a folder called final-final-v3.",
        "Backend engineering, to me, is not just moving data around. It is deciding what the system is allowed to remember and who gets to touch it.",
        "I like systems where the important assumptions are written down, the deployment path is not theatrical, and the database is not treated like a junk drawer.",
        "Most of the work here sits between backend structure and product judgment: enough code to run, enough scope control to remain sane.",
        "I am drawn to projects where the main challenge is not typing code faster, but deciding what the system should never silently do.",
        "The interface may rotate, shuffle, or misbehave aesthetically. The underlying system still has to keep its paperwork in order.",
        "I build personal tools because generic software often solves the average problem, then quietly leaves edge cases for the user.",
        "My projects are compact on the outside and rule-heavy underneath, which is usually where the useful parts are hiding.",
        "I care about APIs, data models, permissions, search paths, and whether the system still makes sense after the first clever sprint.",
        "The homepage has some attitude because the projects are already doing the serious work. Someone had to keep the page from wearing a gray suit.",
        "I prefer building things that can be deployed, inspected, and criticized without requiring everyone to pretend the architecture is obvious.",
        "The through-line is practical structure: services that run, records that persist, boundaries that hold, and interfaces that do not erase the system underneath.",
        "I build software with enough explicitness that maintenance feels like reading a map, not interpreting hints from a past sprint.",
        "I am interested in small systems because small does not mean simple; it just means the complexity has fewer places to hide.",
        "The work here is backend-oriented, product-aware, and allergic to the kind of polish that hides whether anything actually works.",
        "I like software that exposes structure gradually: simple enough to enter, explicit enough to reason about, strict enough to maintain.",
        "The projects below are not trophies. They are evidence: scoped problems, working systems, reviewable choices, and a few marks from reality.",
        "I build systems around data and workflows because a good interface cannot save a product that forgot what it is storing.",
        "My preferred projects have a clear shape: define the objects, protect the boundaries, expose the behavior, and avoid unnecessary mythology.",
        "I care about software that can be explained after it works, because mysterious success often becomes future maintenance work.",
        "The page is a little strange on purpose. The engineering signal underneath is meant to stay plain, readable, and hard to fake.",
        "I build systems that make state, access, and history visible, because hidden complexity has a talent for becoming expensive.",
        "I like when a project has enough personality to be remembered and enough structure to stay understandable.",
        "The homepage experiments with presentation. The projects underneath stay focused on records, services, boundaries, and deployment.",
        "I build backend systems for workflows that need accountability, not just another place to click things until the workflow improves.",
        "The best parts of my work are usually not loud: a clean data model, a clear permission path, and a deployment that does not need dramatic music.",
        "I build with a bias toward explicit rules, because implicit behavior is where software often turns into someone else’s maintenance task."
      ],
      ...
      shapeStyles: ["rounded", "soft-rounded", "right-angle", "small-radius", "pill-boxes", "no-boxes", "line-only", "ticket", "slab", "cut", "stamp", "folder", "postcard", "underline", "offset", "badge", "chamfered", "asymmetric", "tabbed", "inset-edge", "capsule-cards", "top-accent", "bottom-accent", "speech", "bracketed", "double-frame", "split-radius", "leaf", "edge-accent", "diamond-cut", "corner-stripe", "squircle"]
    },
  descriptions: {
      saturn: [
